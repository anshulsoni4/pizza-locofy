...
const ProfileContainer = () => {
  ...
  return (
    <View style={[styles.menu1, styles.menu1FlexBox]}>
      <SearchContainer
        iconText={require("../assets/home.png")}
        navigationText="Home"
        navigationIconText={require("../assets/search.png")}
        navigationSearchText="Search"
      ...
      <ContainerForm
        ...
        onNavigationmenuHomePress1={() => navigation.navigate("HomePage1")}
      />
